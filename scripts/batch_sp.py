...
from qm_automation.workflows import batch_single_point_workflow


def main() -> None:
    parser = argparse.ArgumentParser(description="Batch single-point workflow")
    ...
    parser.add_argument("--workers", type=int, default=4, help="并行提交的任务数")
    parser.add_argument("--nprocs-per-job", type=int, default=4, help="每个量化任务内部使用的核数")
