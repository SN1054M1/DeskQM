...
def main() -> None:
    parser = argparse.ArgumentParser(description="ECD workflow")
    add_common_arguments(parser, task_name="ecd")
    ...
    parser.add_argument("--nstates", type=int, default=30, help="请求的激发态数")
