...
from qm_automation.workflows import single_point_energy


def main() -> None:
    parser = argparse.ArgumentParser(description="Single point workflow")
    add_common_arguments(parser, task_name="single_point")
