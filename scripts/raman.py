...
from qm_automation.workflows import raman_workflow


def main() -> None:
    parser = argparse.ArgumentParser(description="Raman workflow")
    add_common_arguments(parser, task_name="raman")
