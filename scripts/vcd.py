...
from qm_automation.workflows import vcd_workflow


def main() -> None:
    parser = argparse.ArgumentParser(description="VCD workflow")
    add_common_arguments(parser, task_name="vcd", engine_choices=("auto", "orca"))
